...
public class Product {
    ...
    public Product(String productId, String productName, String productImage, float productPrice, String productDescription, STATUS productStatus, CATEGORIZE productCategorize) {
